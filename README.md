...
| [`04-mechanical-design/`](04-mechanical-design/) | Mechanical Design |

Learning material is in [`RESOURCES.md`](RESOURCES.md).
The official write-up of the rules is given in the sheet that should be strictly followed
...
- Pick your domain(s) as per the recruitment sheet.
...
1. **Create your own copy** of this repo. On GitHub click Use this template → Create a new repository
   ...
   Don't clone this repo directly: you won't have access to it.
2. **Clone your copy** to your machine:
   ...
   ```
3. Do the tasks 
4. Commit often with meaningful messages(as president insisted) and push(Dont lose your Progress):
   ```bash
   git add .
...
6.If you are shortlisted you will be called for an intreview!! All the best!!
